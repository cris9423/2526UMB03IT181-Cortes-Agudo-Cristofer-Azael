...
Programa que calcula el factorial de un número mediante dos enfoques: uno iterativo  y recursivo.

## Objetivo

Comparar la solución iterativa y la solución recursiva para el cálculo de factorial.
